        ...
        >
            ...
            <div className="relative z-10 text-center px-6 w-full max-w-xl">
                ...
                >
                    ...
                    <span>Privada · Página perdida</span>
                    <span className="block h-px" style={{ flex: '0 0 80px', background: 'rgba(212,175,55,0.45)' }} />
                </div>

                <div className="priv-hero-animated relative inline-block px-2">
                    {/* Ghost backdrop — large, faded 404 behind the title */}
                    <div
                        aria-hidden="true"
                    ...
                    >
                        <defs>
                            <linearGradient id="flourishGrad404" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <div className="priv-hero-sub" style={{ marginTop: 36 }}>
                    <Link
                        href="/"
